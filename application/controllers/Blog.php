...
class Blog extends MY_Controller {
  ...
  function __construct(){
    ...
    if($this->is_login):
        ...
        elseif($this->moderate):
            ...
            $this->subview = "MEMBER/blog/_blog_view";
        endif;
  ...
  function _seoIndex(){
        $get_last_post = $this->Mdl_blog->blogGet(null,1,"")->result(); 
        foreach($get_last_post as $row):
            $this->data["meta_title"] = $row->og_title;
    ...
    public function index(){
        ...
        //$this->data["get_last_post"] = $get_last_post; 
  ...
  function blogGet($page=1){
    ...
    if(!$this->is_login):
          $where["{$this->_tb_blog}.show_pub !="] = 0;
      endif;
  ...
  function view($bl_uniq_id){
        ...
        $get = $this->Mdl_blog->blogView($bl_uniq_id)->result();
        foreach($get as $row):
  ...
  function blogGetReadInfo($bl_id){
    $get = $this->Mdl_blog->blogView($bl_id)->result();
    $this->o_put["get"] = $get;
    $this->runOutput();
  }
  /*
