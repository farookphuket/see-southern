...
<script charset="utf-8">
            ...
            function myBlogList(ck_myBlog_page=1){
                ...
                url : url,
                    ...
                    $.each(rs.get_my,(i,v)=>{
                        ...
                        let read_url = "<?php echo site_url("blog/view/"); ?>"+v.bl_uniq_id;
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <div class="float-right mb-2">
                <div class="btn-group">
                    <a class="btn btn-warning lnView" data-bl_id="${v.bl_uniq_id}" href="${read_url}" target="_blank">View</a>
    ...
    $my_list.append(tmp);
            ...
            function myBlogSetTmp(){
                ...
                url : url,
                    ...
                    $.each(rs.get,(i,v)=>{
                        ...
                        keyword.val("seo keyword for "+v.tmp_title);
                        keydes.val("your description for "+v.tmp_title);
        ...
        <ul class="list-group pt-2 mb-2">
            <li class="list-group-item active">
                Post by ${v.name} 
            </li>
            <li class="list-group-item">
                date create ${v.bl_date_create} | update ${v.bl_date_update}   
            </li>
            <li class="list-group-item">
                has read ${v.bl_view_count} time(s). 
            </li>
            <li class="list-group-item">
                <div class="float-right">
                <a class="btn btn-primary lnRead" href="${read_url}" target="_blank">
                    Read
               </a> 
               </div>
            </li>
